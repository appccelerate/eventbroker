//-------------------------------------------------------------------------------
// <copyright file="DebugLogger.cs" company="Appccelerate">
...
namespace Appccelerate.EventBroker.Sample
{
    ...
    public class DebugLogger : EventBrokerExtensionBase
    {
        ...
        public override void RegisteredItem(object item)
        {
            ...
            if (namedItem != null)
            {
                Debug.WriteLine("Registered item '{0}' with name '{1}'.", item, namedItem.EventBrokerItemName);
            }
            else
            {
                Debug.WriteLine("Registered item '{0}'.", item);
            }
        }
        ...
        {
            Debug.WriteLine("Topic created: '{0}'.", eventTopic.Uri);
        }
