namespace Appccelerate.EventBroker
{
    ...
    internal static class Guard
    {
        ...
        /// <summary>
        /// Guards against a null argument or empty strings.
        /// </summary>
        /// <param name="parameterName">Name of the parameter.</param>
        /// <param name="argument">The argument.</param>
        /// <exception cref="System.ArgumentException"><paramref name="argument" /> is <c>null</c> or empty.</exception>
        [SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode", Justification = "Distributed as a source code package.")]
        [DebuggerStepThrough]
        public static void AgainstNullOrEmpty(string parameterName, [ValidatedNotNull]string argument)
        {
            if (string.IsNullOrEmpty(argument))
            {
                throw new ArgumentException(parameterName, string.Format(CultureInfo.InvariantCulture, "{0} is null or empty.", parameterName));
            }
        }
